Create PROCEDURE [dbo].[usp_APP_CRCC_CA_BreakPenalty_SpecPay]
(
  @Client varchar(4),
  @GroupCode int,
  @PPED datetime,
...
BEGIN
    ...
    BEGIN
      ...
      BEGIN
        ...
        Update TimeHistory..tblTimeHistDetail Set OutClass = 'S', BillOTRateOverride = @DiffMins,CountAsOT = @ShiftSegmentID where recordid = isnull(@savRecordID,0) 
