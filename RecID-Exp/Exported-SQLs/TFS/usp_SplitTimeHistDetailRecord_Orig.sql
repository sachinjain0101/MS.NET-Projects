Create PROCEDURE [dbo].[usp_SplitTimeHistDetailRecord_Orig]
(
...
Declare @NewRecordID BIGINT  --< @NewRecordId data type is changed from  INT to BIGINT by Srinsoft on 02Sept2016 >--
