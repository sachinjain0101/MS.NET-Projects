...
;WITH  vmsweeks AS (
 SELECT DISTINCT a.client,a.GroupCode,cat.AdditionalLateTimeEntryWks
...
+ @Delim + GroupID
+ @Delim + TimesheetDate
+ @Delim + CASE WHEN MonHrs IN ('0','0.00','0000','') THEN '' ELSE RIGHT('0000' + REPLACE(MonHrs,'.',''),4) END
+ @Delim + CASE WHEN TueHrs IN ('0','0.00','0000','') THEN '' ELSE RIGHT('0000' + REPLACE(TueHrs,'.',''),4) END
+ @Delim + CASE WHEN WedHrs IN ('0','0.00','0000','') THEN '' ELSE RIGHT('0000' + REPLACE(WedHrs,'.',''),4) END
+ @Delim + CASE WHEN ThuHrs IN ('0','0.00','0000','') THEN '' ELSE RIGHT('0000' + REPLACE(ThuHrs,'.',''),4) END
+ @Delim + CASE WHEN FriHrs IN ('0','0.00','0000','') THEN '' ELSE RIGHT('0000' + REPLACE(FriHrs,'.',''),4) END
+ @Delim + CASE WHEN SatHrs IN ('0','0.00','0000','') THEN '' ELSE RIGHT('0000' + REPLACE(SatHrs,'.',''),4) END
+ @Delim + CASE WHEN SunHrs IN ('0','0.00','0000','') THEN '' ELSE RIGHT('0000' + REPLACE(SunHrs,'.',''),4) END
