...
BEGIN TRY
	...
	-- rename Defaults
	------------------------------------
    IF ( OBJECT_ID('DF_tblEmplSites_NewRecordOld') IS NULL
         AND OBJECT_ID('DF_tblEmplSites_NewRecord') IS NOT NULL
       )
        BEGIN
            PRINT CONVERT(VARCHAR(30), GETDATE(), 121)
                + ' -- Renaming: DF_tblEmplSites_NewRecord ...';
            EXEC dbo.sp_rename 'DF_tblEmplSites_NewRecord',
                'DF_tblEmplSites_NewRecordOld', 'OBJECT';
        END;
	...
	-- rename Defaults
	------------------------------------
    IF ( OBJECT_ID('DF_tblEmplSites_NewRecord') IS NULL
         AND OBJECT_ID('DF_tblEmplSites_NewRecordNew') IS NOT NULL
       )
        BEGIN
            PRINT CONVERT(VARCHAR(30), GETDATE(), 121)
                + ' -- Renaming: DF_tblEmplSites_NewRecord ...';
            EXEC dbo.sp_rename 'DF_tblEmplSites_NewRecordNew',
                'DF_tblEmplSites_NewRecord', 'OBJECT';
        END;
