CREATE  Procedure [dbo].[usp_APP_LSA_Calc_Baylor_Hickory_West]
( 
  @Client char(4),
  @GroupCode int,
  @PPED datetime,
...
/*
-- DEBUG SECTION
--select * from tblPeriodEndDates where client = 'LSA' and groupcode = 251400
Declare @Client char(4)
Declare @GroupCode int
Declare @PPED datetime

Select @Client = 'LSA'
Select @GroupCode = 251400
Select @PPED = '09/11/2004'
