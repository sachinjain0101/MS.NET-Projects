...
BEGIN
	...
	SELECT COLUMN_NAME,Data_Type FROM INFORMATION_SCHEMA.COLUMNS
	 	WHERE TABLE_NAME = @tablename and (DATA_TYPE = 'int') and
                     column_Name = @inputcolname
					  -- in ('AprvlAdjOrigRecID','THDRecordID','OrigRecordID','FromRecordID','ToRecordID','DetailRecordID','THD_RecordId','AdjustmentRecordID','RecordID','InOutId','ClkTransNo','JobId','DivisionId')
