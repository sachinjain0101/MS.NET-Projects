...
USE [TimeHistory]
GO
/****** Object:  StoredProcedure [dbo].[usp_APP_GenericPayrollUpload_GetRecs_TRCS]    Script Date: 7/13/2015 3:29:42 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[usp_APP_GenericPayrollUpload_GetRecs_TRCS]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[usp_APP_GenericPayrollUpload_GetRecs_TRCS] AS' 
END
GO
...
/*
BEGIN TRANSACTION
exec usp_APP_GenericPayrollUpload_GetRecs_TRCS_JB 'TRCS', 720501, '6/7/2015', 'No', 'FileNo', '01', '02', '03', 'Staffing', 'No', 'Y'
ROLLBACK

exec usp_APP_GenericPayrollUpload_GetRecs_TRCS 'TRCS', 100, '3/13/2010', '', '', 'W', '', '', '', '', 'Y'

*/



ALTER       procedure [dbo].[usp_APP_GenericPayrollUpload_GetRecs_TRCS]
(
  @Client varchar(4),
  @Group  int,
