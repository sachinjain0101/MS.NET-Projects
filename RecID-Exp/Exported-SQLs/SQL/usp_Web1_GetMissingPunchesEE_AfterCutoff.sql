USE [TimeHistory]
GO
/****** Object:  StoredProcedure [dbo].[usp_Web1_GetMissingPunchesEE_AfterCutoff]    Script Date: 8/7/2015 3:37:13 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[usp_Web1_GetMissingPunchesEE_AfterCutoff]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[usp_Web1_GetMissingPunchesEE_AfterCutoff] AS' 
END
GO

 --  EXEC usp_Web1_GetMissingPunchesEE 14820, 'PRID', 369906, '06/21/15', 2, 4, 491864937 
--   EXEC usp_Web1_GetMissingPunchesEE_AfterCutoff 0, 'OLST', 909300, '2015-02-07 00:00:00', 3, 0, 5541
--   EXEC usp_Web1_GetMissingPunchesEE 0, 'OLST', 909300, '2015-02-07 00:00:00', 3, 0, 5541

ALTER  proc [dbo].[usp_Web1_GetMissingPunchesEE_AfterCutoff] (
  @UserID           int,
  @Client           varchar(4),
  @GroupCode        int,
  @PPED             datetime,
