Create PROCEDURE [dbo].[usp_APP_GenericDataExtract_PNETClockPayfile_Daily]
(
 @Client VARCHAR(4)
,@GroupCode INT
,@PPED DATETIME
...
,@WEDate DATE =
	CASE
		WHEN DATEPART(DW,@PPED) = DATEPART(DW,GETDATE()-1) THEN DATEADD(DD,-7,@PPED)
		ELSE @PPED
	END
,@TransDate DATE = GETDATE() - 1;
