...
/****** Object:  StoredProcedure [dbo].[usp_APP_PuertoRicoOTRules]    Script Date: 10/12/2015 11:17:40 AM ******/
SET ANSI_NULLS ON
GO
...
/*
select * from timecurrent..tblpayrules where client = 'kell' order by recordid desc

begin transaction
exec timehistory..usp_APP_PuertoRicoOTRules '379', 'KELL', 3288, '4/14/2013', 41994
rollback

delete from timehistory..tbltimehistdetail
where client = 'KELL'
and groupcode = 3288
and payrollperiodenddate = '4/14/2013'
and ssn = 41994
and transdate = '4/9/2013'

select * from timecurrent..tblemplassignments where client = 'kell' and groupcode = 2556 and ssn = 20016

--Scenario 1
EXEC TimeHistory..usp_APP_PuertoRicoOTRules '379_FLEX', 'KELL', 3109, '3/10/2013', 17502

--Scenario 2
EXEC TimeHistory..usp_APP_PuertoRicoOTRules '379_FLEX', 'KELL', 3109, '3/10/2013', 92927

--Scenario 3
EXEC TimeHistory..usp_APP_PuertoRicoOTRules '379_FLEX', 'KELL', 3109, '3/10/2013', 63916

--Scenario 4
EXEC TimeHistory..usp_APP_PuertoRicoOTRules '379_FLEX', 'KELL', 3109, '3/10/2013', 97444

--Scenario 5
EXEC TimeHistory..usp_APP_PuertoRicoOTRules '379_FLEX', 'KELL', 3109, '3/3/2013', 63916

--Scenario 6
EXEC TimeHistory..usp_APP_PuertoRicoOTRules '379_FLEX', 'KELL', 3109, '3/3/2013', 17502

--Scenario 6.1
EXEC TimeHistory..usp_APP_PuertoRicoOTRules '379', 'KELL', 3109, '3/3/2013', 97444

--Scenario 7
EXEC TimeHistory..usp_APP_PuertoRicoOTRules '379_FLEX', 'KELL', 3109, '3/3/2013', 92927

--Scenario 8
EXEC TimeHistory..usp_APP_PuertoRicoOTRules '379_FLEX', 'KELL', 3109, '2/24/2013', 63916

--Scenario 9
EXEC TimeHistory..usp_APP_PuertoRicoOTRules '379_FLEX', 'KELL', 3109, '2/24/2013', 17502

--Scenario 10
EXEC TimeHistory..usp_APP_PuertoRicoOTRules '379_FLEX', 'KELL', 3109, '2/24/2013', 92927

--Scenario 15
EXEC TimeHistory..usp_APP_PuertoRicoOTRules '379_FLEX', 'KELL', 3109, '2/24/2013', 41994

--Scenario 16
EXEC TimeHistory..usp_APP_PuertoRicoOTRules '379_FLSA', 'KELL', 3109, '2/24/2013', 97444

--Scenario 17
EXEC TimeHistory..usp_APP_PuertoRicoOTRules '379_FLEX', 'KELL', 3109, '2/24/2013', 97444

-- Luis
EXEC TimeHistory..usp_APP_PuertoRicoOTRules '379_FLEX', 'KELL', 3288, '3/17/2013', 63916

-- David (book + Luis)
EXEC TimeHistory..usp_APP_PuertoRicoOTRules '379', 'KELL', 3109, '3/17/2013', 41994

EXEC TimeHistory..usp_APP_PuertoRicoOTRules '379', 'KELL', 3109, '3/3/2013', 41994


exec usp_APP_PuertoRicoOTRules '379_FLSA', 'KELL',2556,'3/17/2013',85717

begin transaction
exec usp_APP_PuertoRicoOTRules '379_FLSA', 'KELL',3649,'5/12/2013',29504
rollback

begin transaction
exec usp_APP_PuertoRicoOTRules_PYRAMID '379_FLSA', 'KELL',2554,'5/19/2013',41994
rollback

select * from timecurrent..tblemplnames where client = 'kell' and groupcode = 3439 and lastname like '%albal%'

begin transaction
exec usp_APP_PuertoRicoOTRules '379_FLSA', 'KELL',3439,'8/4/2013',23544
rollback


begin transaction
exec usp_APP_PuertoRicoOTRules '', 'KELL',221115,'2015/06/14',372
rollback

*/

ALTER PROCEDURE [dbo].[usp_APP_PuertoRicoOTRules]
(
