USE [TimeHistory]
GO
/****** Object:  StoredProcedure [dbo].usp_Web1_GetPunchLocationsAtSite    Script Date: 3/28/2016 ******/
-- ================================================
SET ANSI_NULLS ON
GO
...
-- =============================================
/**
EXEC TimeHistory..usp_Web1_GetPunchLocationsAtSite
    @Client = 'DAVT' , -- varchar(4)
    @Groupcode = 509100 , -- int
    @SiteNo = 3488 , -- int
    @DeptNo = 0 , -- int
    @DateRangeStart = null, -- datetime
    @DateRangeEnd = '2016-01-16 00:00:00.000' , -- datetime
    @TimeRangeStart = NULL , -- time
    @TimeRangeEnd = NULL -- time

EXEC usp_Web1_GetPunchLocationsAtSite 'DAVT',509100,3488,0,'1/16/2016','01/16/2016','00:00','00:00',''
EXEC usp_Web1_GetPunchLocationsAtSite 'DAVT',509100,3488,0,'2016-01-16 00:00:00.000','04/09/2016','00:00','00:00'
...
IF NOT EXISTS ( SELECT  *
                FROM    sys.objects
                WHERE   object_id = OBJECT_ID(N'[dbo].[usp_Web1_GetPunchLocationsAtSite]')
                        AND type IN ( N'P', N'PC' ) )
    BEGIN
        EXEC dbo.sp_executesql
            @statement = N'CREATE PROCEDURE [dbo].[usp_Web1_GetPunchLocationsAtSite] AS' 
    END
GO
ALTER PROCEDURE [dbo].[usp_Web1_GetPunchLocationsAtSite]
    (
      @Client VARCHAR(4) = '' ,
      @Groupcode INT = 0 ,
      @SiteNo INT ,
