USE [TimeHistory]
GO
/****** Object:  StoredProcedure [dbo].[usp_APP_AddTimeDetailRec_Out]    Script Date: 3/31/2015 11:53:36 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER OFF
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[usp_APP_AddTimeDetailRec_Out]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[usp_APP_AddTimeDetailRec_Out] AS' 
END
GO

/****** Object:  Stored Procedure dbo.usp_APP_AddTimeDetailRec_Out    Script Date: 7/16/01 5:21:28 PM ******/
...
/*
    ...
    called by virtual time clock
*/
--/*
ALTER         procedure [dbo].[usp_APP_AddTimeDetailRec_Out](
         @Client char(4),
         @GroupCode int ,
         @SSN int ,
