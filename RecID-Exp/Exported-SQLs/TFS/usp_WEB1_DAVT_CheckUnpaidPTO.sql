	...
	BEGIN
      ...
      BEGIN
      	...
      	BEGIN
      		...
      		EXEC [TimeHistory].[dbo].[usp_APP_XLSImport_Adjustment_Insert_THD] @Client, @GroupCode, @PPEDStart, @SSN, 0, 0, 'P', 'UNSCPTO', @TempHours, 0.00, @PPEDStart, @PPEDEnd, 'SYS', 'N'
      		EXEC [TimeHistory].[dbo].[usp_APP_XLSImport_Adjustment_Insert_THD] @Client, @GroupCode, @PPEDStart, @SSN, 0, 0, '<', 'UnPD UnSch', @uPTOTaken, 0.00, @PPEDStart, @PPEDEnd, 'SYS', 'N'
      ...
      BEGIN
      	...
      	BEGIN
      		...
      		EXEC [TimeHistory].[dbo].[usp_APP_XLSImport_Adjustment_Insert_THD] @Client, @GroupCode, @PPEDStart, @SSN, 0, 0, '2', 'PTO', @TempHours, 0.00, @PPEDStart, @PPEDEnd, 'SYS', 'N'
      		EXEC [TimeHistory].[dbo].[usp_APP_XLSImport_Adjustment_Insert_THD] @Client, @GroupCode, @PPEDStart, @SSN, 0, 0, '>', 'UnPD PTO', @PTOTaken, 0.00, @PPEDStart, @PPEDEnd, 'SYS', 'N'
          insert into TimeCurrent..tblWork_DAVT_UnpaidPTO_Audit(GroupCode, SSN, Step, PTO, EIL, PTOTaken, EILTaken, EffDate, Message, PPED)
      ...
      BEGIN
      	...
      	BEGIN
      		...
      		EXEC [TimeHistory].[dbo].[usp_APP_XLSImport_Adjustment_Insert_THD] @Client, @GroupCode, @PPEDEnd, @SSN, 0, 0, 'P', 'UNSCPTO', @TempHours, 0.00, @PPEDEnd, @PPEDEnd, 'SYS', 'N'
      		EXEC [TimeHistory].[dbo].[usp_APP_XLSImport_Adjustment_Insert_THD] @Client, @GroupCode, @PPEDEnd, @SSN, 0, 0, '<', 'UnPD UnSch', @uPTOTaken2, 0.00, @PPEDEnd, @PPEDEnd, 'SYS', 'N'
          insert into TimeCurrent..tblWork_DAVT_UnpaidPTO_Audit(GroupCode, SSN, Step, PTO, EIL, PTOTaken, EILTaken, EffDate, Message,PPED)
      ...
      BEGIN
      	...
      	BEGIN
      		...
      		EXEC [TimeHistory].[dbo].[usp_APP_XLSImport_Adjustment_Insert_THD] @Client, @GroupCode, @PPEDEnd, @SSN, 0, 0, '2', 'PTO', @TempHours, 0.00, @PPEDEnd, @PPEDEnd, 'SYS', 'N'
      		EXEC [TimeHistory].[dbo].[usp_APP_XLSImport_Adjustment_Insert_THD] @Client, @GroupCode, @PPEDEnd, @SSN, 0, 0, '>', 'UnPD PTO', @PTOTaken2, 0.00, @PPEDEnd, @PPEDEnd, 'SYS', 'N'
          insert into TimeCurrent..tblWork_DAVT_UnpaidPTO_Audit(GroupCode, SSN, Step, PTO, EIL, PTOTaken, EILTaken, EffDate, Message, PPED)
