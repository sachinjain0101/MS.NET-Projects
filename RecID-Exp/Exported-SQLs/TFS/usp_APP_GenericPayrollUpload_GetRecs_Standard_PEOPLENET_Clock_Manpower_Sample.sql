Create PROCEDURE [dbo].[usp_APP_GenericPayrollUpload_GetRecs_Standard_PEOPLENET_Clock_Manpower_Sample]
(
  @Client       varchar(4),
  @GroupCode    int,
  @PPED         datetime,
...
Values(1,'1','MISSING','FirstName|LastName|EmplID|Assignment|WeekEnding|TransDate|WorkedHours|PayCode|PayAmt|BillAmt|Project|ApprName|ApprEmail|ApprDate|PayGroup|TimeSource|ApprSource|TimeSheetID|ApprStatus|CRF1Code|CRF1Value|CRF2Code|CRF2Value|CRF3Code|CRF3Value|CRF4Code|CRF4Value|CRF5Code|CRF5Value|CRF6Code|CRF6Value')
