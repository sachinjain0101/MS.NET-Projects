Create PROCEDURE [dbo].[usp_APP_DAVT_UploadPS_GetUploadRecs_PPED_PreClose]
(
  @Client     char(4), 
  @GroupCode  int, 
  @PPED       datetime,
...
--print 'After Job Code true up Elapse Time (secs) = ' + ltrim(str(datediff(second,@StartTime,getdate())))

select @GroupCode, * from #tmpFinal 
