CREATE   Procedure [dbo].[usp_APP_ExpressEmployment_QtrHourRnd]
	@Client varchar(4), 
	@GroupCode int,
	@PPED datetime, 
	@SSN int 
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			SELECT @NewInTime = dbo.RoundQtrHr_InFwd_OutBack (@ActualInTime, 'IN')
...
--						print 'setting up new week'
		...
		BEGIN
			...
			SELECT @NewOutTime = dbo.RoundQtrHr_InFwd_OutBack (@ActualOutTime, 'OUT')
