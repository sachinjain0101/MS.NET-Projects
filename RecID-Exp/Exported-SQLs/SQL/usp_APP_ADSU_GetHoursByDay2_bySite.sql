...
/*
IF @Recordtype = 'A' -- Only send time cards for employees that have all records approved.
   @Recordtype = 'F' -- This is for the final close process. Send all employees that have not 
                          been sent before or have non-approved time
   @RecordType = 'L' -- Employees who enter their time late into a closed week
   @RecordType = 'P' -- Employees whose time was approved after it was sent unapproved in the pay file
*/
/*
EXEC dbo.usp_APP_ADSU_GetHoursByDay2_bySite 
    @Client = 'ADSU' , -- char(4)
    @GroupCode = 647 , -- int
    @PPED = '2014-08-03' , -- datetime
    @PPED2 = '2014-08-03' , -- datetime
    @RecordType = 'F' , -- char(1)
    @REGPAYCODE = 'REG' , -- varchar(10)
    @OTPAYCODE = 'OT' , -- varchar(10)
    @DTPAYCODE = 'DT' , -- varchar(10)
    @ExcludeSubVendors = '0'  -- varchar(1)
    
EXEC dbo.usp_APP_ADSU_GetHoursByDay2_bySite 
    @Client = 'ADSU' , -- char(4)
    @GroupCode = 114 , -- int
    @PPED = '2013-03-17 00:00:00.000' , -- datetime
    @PPED2 = '2013-03-17 00:00:00.000' , -- datetime
    @RecordType = 'A' , -- char(1)
    @REGPAYCODE = 'REG' , -- varchar(10)
    @OTPAYCODE = 'OT' , -- varchar(10)
    @DTPAYCODE = 'DT' , -- varchar(10)
...
*/
--EXEC TimeHistory..usp_APP_GenericPayrollUpload_GetRecs_ADSU 'ADSU', 134, '3/17/2013', '', 'FILENO', 'REG', 'OT', 'DT','A',''

/*
EXEC usp_APP_ADSU_GetHoursByDay2_bySite  
@Client='ADSU',
@GroupCode=113,
@PPED='Mar 16 2013 12:00AM',
@PPED2='Mar 16 2013 12:00AM',
@RecordType='A',
@REGPAYCODE='REG',
@OTPAYCODE='OT',
@DTPAYCODE='DT',
...
@Client='ADSU',
@GroupCode=114,
@PPED='Mar 31 2013 12:00AM',
@PPED2='Mar 31 2013 12:00AM',
@RecordType='L',
@REGPAYCODE='REG',
@OTPAYCODE='OT',
@DTPAYCODE='DT',
...
begin transaction
 update timehistory..tblemplsites_depts set payrecordssent = NULL WHERE client = 'adsu' AND ssn = 100000908 AND PayrollPeriodEndDate = '3/15/2013'
 
 EXEC usp_APP_ADSU_GetHoursByDay2_bySite_GG
    @Client='ADSU',
    @GroupCode=287,
    @PPED='2013-03-15 00:00:00.000',
    @PPED2='2013-03-15 00:00:00.000',
    @RecordType='L',
    @REGPAYCODE='REG',
    @OTPAYCODE='OT',
    @DTPAYCODE='DT',
...
ALTER PROCEDURE [dbo].[usp_APP_ADSU_GetHoursByDay2_bySite]
( 
  @Client             CHAR(4),
  @GroupCode          INT,
  @PPED               DATETIME ,
