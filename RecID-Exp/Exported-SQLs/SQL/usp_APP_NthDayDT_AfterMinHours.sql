USE [TimeHistory]
GO
/****** Object:  StoredProcedure [dbo].[usp_APP_NthDayDT_AfterMinHours]    Script Date: 6/1/2015 9:29:24 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[usp_APP_NthDayDT_AfterMinHours]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[usp_APP_NthDayDT_AfterMinHours] AS' 
END
GO

-- exec usp_APP_NthDayDT_AfterMinHours_JB 1.50,1,40,40,'MPOW',231033,'5/31/2015',000006947
-- 2761
-- exec usp_APP_NthDayDT_AfterMinHours_JB 1.50,1,40,40,'OLST',911700,'5/31/2015',000006981
-- exec usp_APP_NthDayDT_AfterMinHours 1.50,1,40,40,'MPOW',231033,'9/20/2015',000008699
-- exec usp_APP_NthDayDT_AfterMinHours 1.50,1,40,40,'MPOW',231033,'12/6/2015',000008699

ALTER Procedure [dbo].[usp_APP_NthDayDT_AfterMinHours]
(
  @OTMult numeric(7,3),
  @NthDay INT,
