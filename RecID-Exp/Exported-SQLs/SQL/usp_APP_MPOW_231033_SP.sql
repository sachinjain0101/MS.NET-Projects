USE [TimeHistory]
GO
/****** Object:  StoredProcedure [dbo].[usp_APP_MPOW_231033_SP]    Script Date: 5/11/2015 5:23:22 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[usp_APP_MPOW_231033_SP]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[usp_APP_MPOW_231033_SP] AS' 
END
GO

-- exec usp_APP_MPOW_231033_SP 'MPOW',231033 ,'10/11/2015',000009868

ALTER Procedure [dbo].[usp_APP_MPOW_231033_SP]
(
  @Client varchar(4),
  @GroupCode int,
  @PPED datetime,
