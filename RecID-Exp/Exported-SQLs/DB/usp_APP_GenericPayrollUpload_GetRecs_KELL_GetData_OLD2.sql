CREATE PROCEDURE [dbo].[usp_APP_GenericPayrollUpload_GetRecs_KELL_GetData_OLD2]
(
  @Client         varchar(4),
  @GroupCode      int,
  @PPED           datetime,
...
BEGIN
    ...
    SELECT 
       ...
       , OTOverride = SUM(CASE WHEN TimeHistory.dbo.fn_DoesOTOExist (@Client, @GroupCode, t.SSN,	t.PayrollPeriodEndDate) = 1 OR 
