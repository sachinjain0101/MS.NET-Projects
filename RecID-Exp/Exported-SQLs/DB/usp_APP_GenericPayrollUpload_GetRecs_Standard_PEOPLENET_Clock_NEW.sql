CREATE PROCEDURE [dbo].[usp_APP_GenericPayrollUpload_GetRecs_Standard_PEOPLENET_Clock_NEW]
(
  @Client       varchar(4),
  @GroupCode    int,
  @PPED         datetime,
...
Values(1,'1','MISSING',
'FirstName|LastName|EmplID|Assignment|WeekEnding|TransDate|PayCode|PayAmt|BillAmt|Project|ApprName|ApprEmail|ApprDate|PayGroup|TimeSource|ApprSource')
