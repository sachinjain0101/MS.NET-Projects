USE [TimeHistory]
GO
/****** Object:  StoredProcedure [dbo].usp_Web1_FixRecordInFixedPunchEE    Script Date: 8/10/2015 ******/
-- ================================================
SET ANSI_NULLS ON
GO
...
IF NOT EXISTS ( SELECT  *
                FROM    sys.objects
                WHERE   object_id = OBJECT_ID(N'[dbo].[usp_Web1_FixRecordInFixedPunchEE]')
                        AND type IN ( N'P', N'PC' ) )
    BEGIN
        EXEC dbo.sp_executesql
            @statement = N'CREATE PROCEDURE [dbo].[usp_Web1_FixRecordInFixedPunchEE] AS' 
    END
GO
ALTER PROCEDURE [dbo].[usp_Web1_FixRecordInFixedPunchEE]
    (
